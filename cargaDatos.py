...
des_colonial = Mod_Destino.Destino('La Colonial')
...
act1_mercado = Mod_Actividad.Actividad('Concurso de empanadas', des_mercado.id_destino)
act1_mercado.cambiar_hora('2023-07-04T10:00:00')
act2_mercado = Mod_Actividad.Actividad('Concurso de pizzas', des_mercado.id_destino)
act2_mercado.cambiar_hora('2023-07-04T13:00:00')
act1_colonial = Mod_Actividad.Actividad('Recital folclore', des_colonial.id_destino)
act1_colonial.cambiar_hora('2023-07-04T20:00:00')

# Creacion ruta visitas

ruta1 = Mod_RutaVisita.Ruta_Visita('Mi ruta')
ruta1.agregar_visita(des_mercado.id_destino)
ruta1.agregar_visita(des_colonial.id_destino)

# Creacion usuario

usuario1 = Mod_Usuario.Usuario('Juan','Perez')
usuario1.agregar_ruta(ruta1.id_visita)

# Creacion review

review1 = Mod_Review.Review(des_mercado.id_destino,usuario1.id_usuario)
review1.cambiar_calificacion(4)
review1.cambiar_comentario('Muy buenas pizzas, mucho ruido')
review1.cambiar_animo('Positivo')
review2 = Mod_Review.Review(des_colonial.id_destino,usuario1.id_usuario)
